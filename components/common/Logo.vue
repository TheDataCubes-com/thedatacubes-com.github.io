<template>
  <NuxtLink to="/">
    <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160.16 108.68">
      <defs>
...
const props = defineProps({
  ...
  noLines: { type: Boolean, default: false },
});

const color = computed(() => props.isWhite ? "#210076" : "#fff");
</script>
